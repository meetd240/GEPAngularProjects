...
import { PurchasePricePopupComponent } from './purchase-price-popup.component';
...
const purchasePrice: IManifestCollection = [
    { path: 'purchase-price-popup', component: PurchasePricePopupComponent }
]
...
@NgModule({
    ...
    declarations: [PurchasePricePopupComponent],
    exports: [],
})
