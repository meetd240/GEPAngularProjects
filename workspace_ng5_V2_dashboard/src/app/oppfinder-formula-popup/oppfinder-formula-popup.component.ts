...
@Component({
    selector: 'oppfinder-formula-popup',
    templateUrl: './oppfinder-formula-popup.component.html',
    styleUrls: ['./oppfinder-formula-popup.component.scss'],
    encapsulation: ViewEncapsulation.None,
    preserveWhitespaces: false
})

export class OppfinderFormulaPopupComponent implements OnInit {
