...
const sidleyaustinSpecificConfig = {
	managerId: 'default',
	...
	widgets: [
    ...
    },
		{
			...
			children: {
                "specificSettings": {
                    "urlFieldVisibility":true,
                    "validateInternalCodeCombination": false,
                    "externalPaginationThreshold": 80,
            ...
            
                    {
                        ...
                        "columnDefs": [
                            ...
                            },
                            {
                                ...
                                "enableCellEdit": true,
								"enableFiltering": true,
                                "rules": ["variableTypeMandatory", "AllowCategoryForPunchoutCheck", "emptyCheck"],
                                "isRegClickCol": true,
                                "attributes": {
                                    "type": "categoryPopup",
                                    "defaultTitle": "Select",
                        ...
                        "columnDefs": [
                            ...
                            },
                            {
                                ...
                                "attributes": {
                                    ...
                                    "isEditable": ["0_1","0_21", "0_23", "0_24", "0_121"],
                                },
                                "filterObject": {
                                    "enableFiltering": true
                                }
...
const mergedConfig = mergeConfigs(defaultManagerConfig, sidleyaustinSpecificConfig);
