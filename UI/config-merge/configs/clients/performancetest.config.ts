...
const performancetestSpecificConfig = {
    managerId: 'default',
                ...
                "grid": [
                    {
                        ...
                        "columnDefs": [
                            ...
                            },
                            {
                                ...
                                "isRegFocusCol": true,
                                "data": "contractNumber",
                                "rules": ["contractNumberInternalItemEditableCheck","isNeedByDateGreaterThanContractExpiryDate"],
                                "enableCellEdit": true,
                                "enableFiltering": true,
                                "attributes": {
                                    "isEditable": ["0_1", "0_23", "0_24", "0_121", "0_202", "0_1_3", "0_202_3"],
...
const mergedConfig = mergeConfigs(defaultManagerConfig, performancetestSpecificConfig);
