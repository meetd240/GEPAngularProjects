...
import { IWidgetsConfig, WidgetsManagerLayoutEnum, WidgetTypesEnum, ITextInput, IAutosuggestInput, ISelectInput, ICheckboxInput, TextInput } from "../../smart-core-types";
import * as write from "write";
import * as path from "path";
import { DataModelNames } from '../../../src/modules/enums/sections.enum';
import { inputsFactory } from "../base/inputs.factory";
const kiewitSpecificConfig = {
    managerId: 'default',
    ...
    widgets: [
        ...
        },
        {
            ...
            behaviour: {
                ...
                isShown: ["1_1", "0_1", "0_23", "0_24", "0_121", "0_121", "0_21", "0_22", "0_62", "0_61", "0_56", "0_202"]
            },
            children: [
                ...
                "grid": [
                    {
                        ...
                        "gridActions": [
                            ...
                            },
                            {
                                ...
                                "isVisible": "p2pValidationService.isVisibleForGrid",
                                "isShown": ["1_1", "0_1", "0_23", "0_24", "0_1_3", "0_23_3", "0_24_3", "0_202"],
                                "id": "addFrom"
                            },
                            {
                                "title": "P2P_Req_Managed_Column",
                                "isVisible": "p2pValidationService.isVisibleForGrid",
                                "isShown": ["1_1", "0_1", "0_23", "0_24", "0_121", "0_21", "0_22", "0_62", "0_61", "0_56", "0_1_3", "0_23_3", "0_24_3", "0_202"],
                                "id": "manageColumns"
                            },
                            {
                            ...
                            },
                            {
                                ...
                                "isVisible": "p2pValidationService.isVisibleForGrid",
                                "isShown": ["1_1", "0_1", "0_23", "0_24", "0_121", "0_21", "0_22", "0_62", "0_61", "0_56", "0_1_3", "0_202"],
                                "id": "showFilters"
                            },
                            {
                        ...
                        "columnDefs": [
                            ...
                            },
                            {
                                ...
                                "isReadOnly": "p2pValidationService.isReadOnly",
                                "uiType": "editable",
                                "rules": ["quantityFixedDisable", "quantityNegativeCheck"],
                                "enableCellEdit": true,
                                "enableFiltering": true,
                                "isRegUpdateCol": true,
                                "attributes": {
...
const mergedConfig = mergeConfigs(defaultManagerConfig, kiewitSpecificConfig);
