...
import { IWidgetsConfig, WidgetsManagerLayoutEnum, WidgetTypesEnum, ITextInput, IAutosuggestInput, ICheckboxInput, customInput,BaseInput,IBaseInput, ISelectInput } from "../../smart-core-types";
import * as write from "write";
import * as path from "path";
import { DataModelNames } from '../../../src/modules/enums/sections.enum';
const exxonmobilSpecificConfig = {
	managerId: 'default',
        ...
        },
		{
			...
			children: {
                "specificSettings": {
                    ...
                    "contractNumberType": {
                        "controlType": 2 //1--Auto suggest only,2--Free text only,3--	Auto suggest and free text 
                    }
            ...
            
                    {
                        ...
                        "gridActions": [

                            {
                                ...
                                "isShown": ["1_1", "0_1", "0_23", "0_24" , "0_121", "0_202", "0_1_3"],
                                "id": "add"
                            },
                            {
                            ...
                            },
                            {
                                ...
                                "isVisible": "p2pValidationService.isVisibleForGrid",
                                "isShown": ["1_1", "0_1", "0_23", "0_24" , "0_121", "0_21", "0_22", "0_62", "0_61", "0_254", "0_56", "0_202", "0_1_3"],
                                "id": "manageColumns"
                            },
                            {
                        ...
                        "columnDefs": [
                            ...
                            },
                            {
                                ...
                                "Changereq": "Changereq",
                                "attributes": {
                                    "isShown": ["0_1", "0_23", "0_24", "0_42", "0_59", "0_169", "0_21", "0_121", "0_121_5", "0_121_10", "0_1_10", "0_78", "0_1_4", "0_1_5", "0_25_10", "0_41_10", "0_169_4", "0_169_5", "0_21_5", "0_22_5", "0_23_5", "0_24_5", "0_25_5", "0_41_5", "0_42_5", "0_121_4", "1_121_4", "0_141", "0_141_4", "0_1_3", "0_23_3", "0_24_3", "0_202", "0_1_3"],
                                    "isEditable": []
                                },
                                "filterObject": {
                                    "enableFiltering": true
            ...
            
                            {
                                ...
                                "attributes": {
                                    ...
                                    "isEditable": ["0_1", "0_23", "0_24" , "0_121", "0_202", "0_1_3"],
                                    "populateListOnFocus": true,
                                    "minchars": 0
                                },
                                "filterObject": {
            ...
            
                            {
                                ...
                                "enableCellEdit": true,
                                "enableFiltering": true,
                                "rules": ["emptyCheck", "grayOutNonEditable"],
                                "attributes": {
                                    "isEditable": []
                                },
                                "filterObject": {
...
const mergedConfig = mergeConfigs(defaultManagerConfig, exxonmobilSpecificConfig);
