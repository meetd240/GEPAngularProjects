...
const s2csandbox2SpecificConfig = {
    managerId: 'default',
                        ...
                        "gridActions": [
                            {
                                ...
                                "isShown": ["1_1", "0_1", "0_23", "0_24", "0_121", "0_202","0_1_3", "0_23_3", "0_24_3","0_202_3"],
                                "id": "add"
                            },
                            {
                            ...
                            },
                            {
                                ...
                                "isVisible": "p2pValidationService.isVisibleForGrid",
                                "isShown": ["1_1", "0_1", "0_23", "0_24", "0_121", "0_21", "0_22", "0_62", "0_61", "0_254", "0_56", "0_202","0_1_3", "0_23_3", "0_24_3","0_202_3"],
                                "id": "manageColumns"
                            },
                            {
                        ...
                        "columnDefs": [
                            ...
                            },
                            {
                                ...
                                "attributes": {
                                    "type": "autocomplete",
                                    "model": "description",
                                    "filterkeys": ["desc","itemdescription"],
                                    "maxlength": 1000,
                                    "displayformat": "{desc}",
                                    "optionformat": "{code}:{name}:{partner}:{desc}",
                                    "isEditable": ["0_1", "0_23", "0_24", "0_121", "0_202"]
...
const mergedConfig = mergeConfigs(defaultManagerConfig, s2csandbox2SpecificConfig);
