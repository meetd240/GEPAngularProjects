                    ...
                    "gridActions": [
                        {
                            ...
                            "isShown": ["1_1", "0_1", "0_23", "0_24", "0_121"],
                            "id": "add"
                        },
                        {
                        ...
                        "showLookup": true,
                            ...
                            },
                            {
                                ...
                                "attributes": {
                                    ...
                                    "filterkeys": ["desc"],
                                    "displayformat": "{desc}",
                                    "optionformat": "{code}:{partner}:{desc}",
                                    "isEditable": ["0_1", "0_23", "0_24", "0_121"]
                                },
                                "filterObject": {
                                    "enableFiltering": true
                            ...
                            },
                            {
                                ...
                                "isReadOnly": "p2pValidationService.isReadOnly",
                                "uiType": "editable",
                                "rules": ["materialCheckDisable", "variableTypeMandatory", "DateFormatCheck", "startDateGreatedED", "enableContractPeriodValidationForSerivceLineItems"],
                                "attributes": {
                                    "type": "date",
                                    "format": "MM/dd/yyyy",
                                    "isEditable": ["0_1", "0_23", "0_24", "0_121"],
                            ...
                            },
                            {
                                ...
                                "enableCellEdit": true,
								"enableFiltering": true,
                                "rules": ["materialCheckDisable", "variableTypeMandatory", "DateFormatCheck", "endDateLessThanSD", "enableContractPeriodValidationForSerivceLineItems"],
                                "attributes": {
                                    "type": "date",
                                    "format": "MM/dd/yyyy",
                                    "isEditable": ["0_1", "0_23", "0_24", "0_121"],
...
const mergedConfig = mergeConfigs(defaultManagerConfig, petronasSpecificConfig);
