...
import { IWidgetsConfig, WidgetsManagerLayoutEnum, WidgetTypesEnum, ITextInput, IAutosuggestInput, ICheckboxInput, customInput,BaseInput,IBaseInput, ISelectInput, TextInput, AutosuggestInput, inputsFactory } from "../../smart-core-types";
import * as write from "write";
import * as path from "path";
import { DataModelNames } from '../../../src/modules/enums/sections.enum';
const abmSpecificConfig = {
	managerId: 'default',
		...
		},
		{
			...
			children: {
                ...
                },
                {
                    ...
                    "isVisible": true,
                    "isReadOnly": "p2pValidationService.isReadOnly",
                    "rules": ["SourceTypeCheck", "emptyCheckItemMaster"],
                    "attributes": {
                        "type": "autocomplete",
                ...
                },
                {
                    ...
                    "enableCellEdit": true,
                    "enableFiltering": true,
                    "rules": ["variableDisable", "needbydateCheck", "needbydateLTRDCheck", "emptyCheck", "isNeedByDateLessThanCurrentDate"],
                    "attributes": {
                        "type": "date",
                        "isEditable": ["0_1", "0_23", "0_24" , "0_121", "0_202"],
                        "format": "MM/dd/yyyy",
...
const mergedConfig = mergeConfigs(defaultManagerConfig, abmSpecificConfig);
