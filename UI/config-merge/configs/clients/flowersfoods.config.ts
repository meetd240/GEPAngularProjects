...
import { IWidgetsConfig, WidgetsManagerLayoutEnum, WidgetTypesEnum, ITextInput, IAutosuggestInput, BaseInput, IBaseInput, ICheckboxInput, inputsFactory, AutosuggestInput, TextInput } from "../../smart-core-types";
import * as write from "write";
import * as path from "path";
import { DataModelNames } from '../../../src/modules/enums/sections.enum';
const flowersfoodsSpecificConfig = {
    managerId: 'default',
    ...
    widgets: [
        ...
        },
        {
            ...
            type: WidgetTypesEnum.Standard,
            manifestPath: 'sdts/sdiw:deliveryInvoicing',
            behaviour: {
                isVisible: true,
                isOptional: false,
                isCollapsible: true,
...
const mergedConfig = mergeConfigs(defaultManagerConfig, flowersfoodsSpecificConfig);
