...
import { IWidgetsConfig, WidgetsManagerLayoutEnum, WidgetTypesEnum, ITextInput, IAutosuggestInput, ICheckboxInput, customInput,BaseInput,IBaseInput, inputsFactory } from "../../smart-core-types";
import * as write from "write";
import * as path from "path";
import { DataModelNames } from '../../../src/modules/enums/sections.enum';
const alnylam20SpecificConfig = {
	managerId: 'default',
...
const mergedConfig = mergeConfigs(defaultManagerConfig, alnylam20SpecificConfig);
